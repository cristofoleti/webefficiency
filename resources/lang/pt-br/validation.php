...
return [
    ...
    */
    ...
    'custom' => [
        'variable_tag' => [
            'required' => 'Selecione uma variável',
        ],
        'start_date_submit' => [
            'required' => 'Insira a Data Inicial',
            'before' => 'A data inicial deve ser menor que a data final',
        ],
        'end_date_submit' => [
            'required' => 'Insira a Data Final',
            'after' => 'A data final deve ser maior que a data inicial',
        ],
    ],
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'attributes' => [
        'start_date_submit' => 'Data Inicial',
        'end_date_submit' => 'Data Final',
    ],
